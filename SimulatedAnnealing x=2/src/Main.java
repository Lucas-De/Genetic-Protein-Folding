...
public class Main {
    ...
    //    static String chain = "HHPHHHPHPHHHPH";
    //    static String chain = "HPHPPHHPHPPHPHHPPHPH";
    //    static String chain = "PPPHHPPHHPPPPPPHHHHHHHPPHHPPPPHHPPHPP";
    static String chain = "HHPHPHPHPHPHHPHPPPHPPPHPPPPHPPPHPPHPHHPHPHPHPHPHPH";
